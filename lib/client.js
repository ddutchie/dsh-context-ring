...
var ContextRingWidget = (props) => {
  ...
  const label = { color: "var(--text-secondary,#a1a1aa)" };
  const val = { fontWeight: 500, color: "var(--text-primary,#f4f4f5)" };
  return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { position: "relative", display: "inline-flex", alignItems: "center" }, ref: popoverRef, children: [
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { fontWeight: 500, color: "var(--text-primary,#ddd)" }, children: formatTokens(promptTokens) })
        ]
      }
    ),
    open && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { style: { ...row, paddingBottom: 8, borderBottom: "1px solid var(--border,#27272a)" }, children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { style: { fontWeight: 600, color: "var(--text-primary,#f4f4f5)" }, children: "Context Breakdown" }),
