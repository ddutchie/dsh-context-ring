...
var ContextRingWidget = (props) => {
  ...
  const tokenUsage = props.useProjection ? props.useProjection("tokenUsage") : void 0;
  const contextPressure = props.useProjection ? props.useProjection("contextPressure") : void 0;
  const contextBreakdown = props.useProjection ? props.useProjection("contextBreakdown") : void 0;
  const tu = tokenUsage;
  const cp = contextPressure;
  const derivedInput = (tu?.uncachedInputTokens ?? tu?.inputTokens ?? 0) + (tu?.cacheReadTokens ?? 0);
  const promptFromPressure = cp?.pressureTokens ?? cp?.current;
  const usage = props.usage ?? (tokenUsage || contextPressure ? {
    ...
    /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)(
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "font-medium text-[var(--text-primary,#ddd)]", children: formatTokens(promptTokens) })
        ]
      }
    ),
    open && /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "absolute bottom-full mb-2 left-0 z-50 w-72 p-3.5 rounded-xl bg-[var(--surface-1,#18181b)] border border-[var(--border,#27272a)] shadow-2xl backdrop-blur-md text-xs text-[var(--text-primary,#f4f4f5)] animate-in fade-in zoom-in-95 duration-150 select-none pointer-events-auto", children: [
      /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between pb-2 border-b border-[var(--border,#27272a)]", children: [
        /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "font-semibold text-xs text-[var(--text-primary,#f4f4f5)]", children: "Context Breakdown" }),
        /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("span", { className: "text-[0.7rem] font-mono px-1.5 py-0.5 rounded bg-[var(--surface-2,#27272a)] text-[var(--text-secondary,#a1a1aa)]", children: [
          percentFull,
          "% Full (~",
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "w-full h-1.5 rounded-full overflow-hidden flex bg-[var(--surface-3,#3f3f46)] my-3 gap-0.5", children: categories.map((c, i) => {
      ...
      /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("div", { className: "space-y-1.5 text-[0.75rem] font-mono", children: categories.map((c, i) => {
        if (!c.count || c.count <= 0) return null;
        return /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center justify-between", children: [
          /* @__PURE__ */ (0, import_jsx_runtime2.jsxs)("div", { className: "flex items-center gap-1.5", children: [
            /* @__PURE__ */ (0, import_jsx_runtime2.jsx)("span", { className: "w-2 h-2 rounded-full flex-shrink-0", style: { backgroundColor: c.color } }),
