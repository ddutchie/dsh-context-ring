...
function apply(ctx) {
  const ContextRingWidget = (props) => {
    ...
    return import_react2.default.createElement(
      ...
      import_react2.default.createElement(ContextRing, { usage, size: 16, strokeWidth: 2.5 }),
      import_react2.default.createElement(
        "span",
        { className: "font-semibold text-[var(--text-primary,#fff)]" },
        (usage.promptTokens || 0).toLocaleString() + " tokens"
      ),
      usage.costUsd != null && usage.costUsd > 0 ? import_react2.default.createElement("span", { className: "text-[var(--text-tertiary,#666)]" }, " \xB7 $" + Number(usage.costUsd).toFixed(4)) : null
    );
  };
