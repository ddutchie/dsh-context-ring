...
export const ContextRingWidget = (props) => {
    ...
    const contextPressure = useProjection ? useProjection("contextPressure") : undefined;
    const contextBreakdown = useProjection ? useProjection("contextBreakdown") : undefined;
    ...
    return (_jsxs("div", { style: { position: "relative", display: "inline-flex", alignItems: "center" }, ref: popoverRef, children: [_jsxs("button", { type: "button", onClick: () => setOpen(!open), title: "Click to view full context & token breakdown", style: {
                    display: "flex",
                    alignItems: "center",
                    gap: 8,
                    padding: "4px 10px",
                    ...
                    userSelect: "none",
                    lineHeight: 1,
                }, children: [_jsx(ContextRing, { usage: usage, size: 14, strokeWidth: 2.5, categories: ringCategories, fillColor: props.ringFillColor }), _jsx("span", { style: { fontWeight: 500, color: C.textPrimary }, children: formatTokens(promptTokens) })] }), open && (_jsxs("div", { style: {
                    position: "absolute",
                    bottom: "100%",
                    left: 0,
                    marginBottom: 8,
                    ...
                    color: C.textPrimary,
                    userSelect: "none",
                }, children: [_jsxs("div", { style: { ...row, paddingBottom: 8, borderBottom: `1px solid ${C.border}` }, children: [_jsx("span", { style: { fontWeight: 600, color: C.textPrimary }, children: "Context Breakdown" }), _jsxs("span", { style: {
                                    fontSize: "0.7rem",
                                    padding: "2px 6px",
                                    borderRadius: 4,
                                    background: C.surface2,
                                    color: C.textSecondary,
                                }, children: [percentFull, "% Full (~", formatTokens(promptTokens), " / ", formatTokens(contextLimit), ")"] })] }), _jsx("div", { style: {
                            width: "100%",
                            height: 6,
                            borderRadius: 9999,
                            overflow: "hidden",
                            ...
                            return (_jsx("div", { style: { width: `${width}%`, backgroundColor: c.color }, title: `${c.label}: ${formatTokens(c.count)}` }, i));
                        }) }), _jsx("div", { style: { display: "flex", flexDirection: "column", gap: 6 }, children: categories.map((c, i) => {
                            if (!c.count || c.count <= 0)
                                return null;
                            return (_jsxs("div", { style: row, children: [_jsxs("div", { style: { display: "flex", alignItems: "center", gap: 6 }, children: [_jsx("span", { style: { width: 8, height: 8, borderRadius: 9999, flexShrink: 0, backgroundColor: c.color } }), _jsx("span", { style: label, children: c.label })] }), _jsx("span", { style: val, children: formatTokens(c.count) })] }, i));
                        }) }), completionTokens > 0 && (_jsxs("div", { style: { paddingTop: 8, marginTop: 8, borderTop: "1px solid var(--border,#27272a)", display: "flex", flexDirection: "column", gap: 4 }, children: [_jsxs("div", { style: row, children: [_jsx("span", { style: label, children: "Output / Completion" }), _jsx("span", { style: { fontWeight: 500 }, children: formatTokens(completionTokens) })] }), reasoningTokens > 0 && (_jsxs("div", { style: { ...row, color: "var(--text-tertiary,#71717a)" }, children: [_jsx("span", { children: "\u2514 Thinking / Reasoning" }), _jsx("span", { children: formatTokens(reasoningTokens) })] }))] })), (cacheRead > 0 || cacheCreation > 0) && (_jsxs("div", { style: { ...row, paddingTop: 8, marginTop: 8, borderTop: "1px solid var(--border,#27272a)" }, children: [_jsx("span", { style: label, children: "Prompt Cache Read" }), _jsxs("span", { style: { color: "#34d399", fontWeight: 500 }, children: [formatTokens(cacheRead), " tokens"] })] })), costUsd != null && (_jsxs("div", { style: { ...row, paddingTop: 8, marginTop: 8, borderTop: "1px solid var(--border,#27272a)" }, children: [_jsx("span", { style: label, children: "Turn Cost" }), _jsxs("span", { style: { color: "#fbbf24", fontWeight: 600 }, children: ["$", costUsd < 0.01 ? "<0.01" : costUsd.toFixed(4)] })] }))] }))] }));
};
/**
...
export function apply(ctx) {
    ...
    if (ctx?.slots?.inject) {
        ...
        ctx.slots.inject("conversation.composer.dock", () => ctx.slots.register({ name: "conversation.composer.dock", id: "context-ring", order: 5 }, ContextRingWidget));
        return;
    }
